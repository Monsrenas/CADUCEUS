<form wire:submit.prevent="submit" enctype="multipart/form-data">
    ...
    <select name="coder_type"  wire:model='code_id' 
        class="mb-4 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-max py-2 text-sm  text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-green-500">
